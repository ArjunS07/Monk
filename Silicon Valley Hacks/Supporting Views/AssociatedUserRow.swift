...
struct PersonRow_Previews: PreviewProvider {
    static var previews: some View {
        AssociatedUserRow(user: User(name: "Arjun", description: "Lorem ipsum dolor", age: 20, category: "volunteer", languages: ["English", "Spanish"], gender: "male", latitude: 20, longitude: 20))
